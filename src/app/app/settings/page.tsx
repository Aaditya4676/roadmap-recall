...
export default async function SettingsPage() {
  ...
  const { data, error } = await db.from("profiles").select("time_zone, default_scheduler, default_keep_warm_days, reminder_enabled, ai_action_share_personal_notes").single();
